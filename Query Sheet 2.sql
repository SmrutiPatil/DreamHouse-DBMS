...
where Registered_At_Branch="B003" and staff_name="John Doe";
 ...
 where p.Registered_At_Branch=b.Branch_Number
 and b.BCity="Seattle" and rent<45000;
...
where p.Property_Number="4"
and p.Registered_At_Branch=c.Branch_Number
...
where c.PType=p.Type
and c.Max_PRent<=p.Rent;
